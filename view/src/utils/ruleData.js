...
{ "id": "e99b7350da1d6cbd0587c3c3387bcc76", "project": "APP是否说明隐私政策时效", "standard": "1、查看隐私政策条款，是否有隐私政策发布、生效或更新日期信息。2、建议发布日期和生效日或更新日期相差7天。", "riskLevel": 0, "page": 3.0, "okText": "通过（已说明隐私政策时效） ", "failText": "不通过（未说明隐私政策时效） ", "type": "termStatus" },
...
{ "id": "a76167e171c0a6164b9bc54e34405984", "project": "应用分发平台管理责任落实不到位", "standard": "1、通过查看APP内业务功能确认是否存在应用分发行为，如不存在应用分发行为则该项为不适用。2、若检测出 APP 内存在应用分发行为，查看所分发 APP 的开发者身份信息是否不真实或不准确、开发者联系方式是否失效、上架审核存在不严格、违法违规软件处理不及时等情况。", "riskLevel": 2, "page": 10.0, "okText": "通过（应用分发平台管理责任落实到位） ", "failText": "不通过（应用分发平台管理责任落实不到位） ", "type": "userPermissions" }];
