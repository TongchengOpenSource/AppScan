...
{ "id": "e91ca7292b9a9678521cd854fd71793d", "project": "APP是否明示个人信息出境情况", "standard": "1、APP如果有个人信息出境的情况，需要查看隐私政策中是否将出境个人信息类型逐项列出。2、是否将出境个人信息类型显著标识（如字体加粗、标星号、 下划线、斜体、颜色等）。", "riskLevel": 0, "page": 4.0, "okText": "通过（已明示个人信息出境情况） 不通过（未明示个人信息出境情况） ", "failText": "未检测", "type": "externalRules" },
